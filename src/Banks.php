...
use ChainPlatform\Pay\Constants\BankCode;
use ChainPlatform\Pay\Constants\BankKey;

class VietQRStatus
{
    public const NOT_SUPPORTED = -1;
    public const RECEIVE_ONLY = 0;
    public const TRANSFER_SUPPORTED = 1;
}

class Banks
{
    public static function getBanksObject(): array
    {
        return [
            BankKey::ABBANK => [
                'key' => BankKey::ABBANK,
            ...
            BankKey::DBS_BANK => [
                ...
                'name' => 'NH TNHH MTV Phát triển Singapore - CN HCM',
                'bin' => '796500',
                'shortName' => 'DBS Bank',
                'vietQRStatus' => VietQRStatus::RECEIVE_ONLY,
                'lookupSupported' => 0,
            ...
            BankKey::IBK_HCM => [
                ...
                'name' => 'Ngân hàng Công nghiệp Hàn Quốc - CN HCM',
                'bin' => '970456',
                'shortName' => 'IBK HCM',
                'vietQRStatus' => VietQRStatus::RECEIVE_ONLY,
                'lookupSupported' => 0,
            ...
            BankKey::IBK_HN => [
                ...
                'name' => 'Ngân hàng Công nghiệp Hàn Quốc - CN HN',
                'bin' => '970455',
                'shortName' => 'IBK HN',
                'vietQRStatus' => VietQRStatus::RECEIVE_ONLY,
                'lookupSupported' => 0,
            ...
            BankKey::KASIKORN_BANK => [
                ...
                'name' => 'Ngân hàng KASIKORNBANK - CN HCM',
                'bin' => '668888',
            ...
            BankKey::STANDARD_CHARTERED_BANK => [
                ...
                'name' => 'Ngân hàng Standard Chartered VN',
                'bin' => '970410',
    ...
    {
        return array_values(self::getBanksObject());
    }
}
